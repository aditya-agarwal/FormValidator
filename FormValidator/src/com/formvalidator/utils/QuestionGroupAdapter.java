...
public class QuestionGroupAdapter extends ArrayAdapter<GroupInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == rowView) {
            ...
            rowView = ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout
                    .list_view_group_layout, null);
            holder.questionTV = (TextView) rowView.findViewById(R.id.question_group_name);
            holder.requiredTV = (TextView) rowView.findViewById(R.id.question_required_msg);
